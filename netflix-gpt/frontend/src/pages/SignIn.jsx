...
const SignIn = () => {
  ...
  return (
    <div 
    className="min-h-screen bg-cover bg-center justify-center bg-no-repeat px-4 md:px-8 py-5"
    style={{ 
      ...
      <div className='max-w-[450px] w-full bg-black bg-opacity-75 rounded px-8 py-14 mx-auto mt-8'>
        ...
        <form  onSubmit={handleLogin} className='flex flex-col space-y-4'>
            ...
            placeholder='Username or Email or Phone Number'
                className='w-full h-[50px] bg-[#333333] text-white rounded px-5 text-base' 
          ...
          {  error && <p className='text-red-500 text-sm'>{error}</p>}
            ...
            type="submit" 
            disabled={isLoading}
            className='w-full bg-[#e50914] text-white py-2 
