      ...
      <div
        ...
        >
         ...
         <div className='relative z-10 flex items-end p-8 gap-8'>
          ...
          className='rounded-1g shadow-1g w-48 hidden md:block'
          />
          <div>
            ...
            target="_blank">
            <button className='flex items-center justify-center bg-[#e50914] text-white px-4 py-3 rounded-full cursor-pointer hover:bg-[#f40612] transition text-sm md:text-base mt-2 md:mt-4'>
       ...
       <div className='p-8'>
        ...
        <div className='bg-[232323] rounded-1g shadow-1g p-6 flex flex-col md:flex-row gap-8'>
        ...
        <div className='p-8'>
          ...
          {/* <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
            {recommendations.map((rec) => (
              <div key={rec.id} className='bg-gray-800 rounded-lg overflow-hidden shadow-lg'>
                <img src={`https://image.tmdb.org/t/p/w500${rec.poster_path}`} alt={rec.title} className='w-full h-full object-cover' />
                <div className='p-4'>
                  <h3 className='font-semibold text-white'>{rec.title}</h3>
                  <p className='text-gray-400'>{rec.release_date}</p>
                </div>
              </div> 
            ))}
          </div> */}
